...
// Outputs: none
void Timer5B_Init(void(*task)(void), uint32_t period, uint32_t priority){
  ...
  TIMER5_ICR_R = 0x00000001;    // 6) clear TIMER5B timeout flag
...
// vector number 108, interrupt number 92
  ...
  TIMER5_CTL_R = 0x00000001;    // 10) enable TIMER5B
}
