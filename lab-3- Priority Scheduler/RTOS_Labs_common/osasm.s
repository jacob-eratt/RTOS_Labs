...
Thread_Stack_init
	...
	MOVS R2, #1<<24 ;PSR set with thumb but 
	STR R2, [R1] ;Store PSR on stack 
	SUBS R1, #4 ;decrement stack pointer 
	STR R0, [R1] ;store function pointer. When getting popped this will go to PC
	SUBS R1, #4 ;decrement stack pointer for LR. Since we are initializing a thread the LR is garabage
	MOVS R12, #12 
	SUBS R1, #4 ;decrement stack pointer for r12
	STR R12, [R1] 	
	SUBS R1, #48 ;R3-r0, r11-r4 
	MOVS R0, R1
